...
/// Full-screen crop UI locked to the customer app product card aspect ratio.
  ...
  static Future<Uint8List?> open(
    ...
    return Navigator.of(context).push<Uint8List>(
      MaterialPageRoute<Uint8List>(
        ...
        builder: (_) => ProductImageCropPage(imageBytes: imageBytes),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Crop product photo'),
        leading: IconButton(
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text(
              'Frame the photo to match how customers see this product in the app.',
          ...
          Expanded(
            child: Padding(
              ...
              child: Crop(
                ...
                aspectRatio: ProductImageSpec.cropAspectRatio,
                interactive: true,
