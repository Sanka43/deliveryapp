...
class GroceryPageSearchBar extends ConsumerWidget {
  const GroceryPageSearchBar({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return MndPressable(
      onTap: () => navigateToSearchWithQuery(ref, context, 'Groceries'),
      child: Container(
        height: 48,
        ...
        child: Row(
          children: <Widget>[
            ...
            Expanded(
              child: Text(
                'Search groceries, stores, essentials…',
                maxLines: 1,
