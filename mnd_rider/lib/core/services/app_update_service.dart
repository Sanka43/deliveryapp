...
import 'package:mnd_rider/core/widgets/app_update_dialog.dart';
import 'package:package_info_plus/package_info_plus.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:url_launcher/url_launcher.dart';

/// Doc id for this app inside the shared `app_config` collection —
/// mnd_customer and mnd_shop each own their own doc id in the same collection.
const String _kAppConfigDocId = 'rider';
...
/// Reads the `app_config/rider` doc and, if the installed build is behind,
